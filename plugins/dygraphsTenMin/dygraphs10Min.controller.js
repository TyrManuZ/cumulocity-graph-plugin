(function () {
  ...
  angular
    ...
    .controller('dygraphsController10Min', dygraphsController10Min);

  /* @ngInject */
  function dygraphsController10Min(
    $scope,
    c8yTitle,
    c8yMeasurements,
    gettext
    ...
    function buildData(measurements) {
      ...
      _.forEach(measurements, function(measurement) {
        ...
        var seriesRow = buildRow(measurement.c8y_SmallExperimentMeasurements, baseDateParts);
    ...
    function init() {
      c8yMeasurements.list(
        {
          fragmentType: 'c8y_SmallExperimentMeasurements',
          source: '1096859',
          dateFrom: '2017-09-21',
          dateTo: '2017-09-24'
        }
